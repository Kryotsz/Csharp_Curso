...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // o select tem que estar depois do from
        var r1 =
            from p in products
        ...
        // tem que fazer a ordem inversa dos orderby
        //var r4 =
        //    from p in products
        ...
        // desse jeito é melhor de escrever, o orderby fica na mesma linha e não precisa inverter
        var r4 =
            from p in products
            where p.Category.Tier == 1
        ...
        // faz a consulta utilizando SQL e depois utiliza o C#
        var r5 =
            (from p in r4
             select p)
             .Skip(2)
